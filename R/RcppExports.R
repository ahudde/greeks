...
BS_European_Greeks_cpp <- function(initial_price, exercise_price, r, time_to_maturity, volatility, dividend_yield, payoff, greek) {
...
BS_Implied_Volatility_cpp <- function(option_price, initial_price, exercise_price, r, time_to_maturity, dividend_yield, payoff, start_volatility, precision, max_iter) {
    .Call(`_greeks_BS_Implied_Volatility_cpp`, option_price, initial_price, exercise_price, r, time_to_maturity, dividend_yield, payoff, start_volatility, precision, max_iter)
}
